...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	status = xTaskCreate(task1_handler, "Task1", 200, "Task1 : Coe man ", 1, &task1_handle);
	...
	// If comes here, then the launch of the scheduler has failed to insufficient memory in heap
